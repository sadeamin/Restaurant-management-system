...
def Manage_menu_window():
    ...
    button_edit_item = Button(frame_buttons, text="Edit New menu item", bg="blue", fg="white")
    button_edit_item.grid(ipadx=30, ipady=20, row=0, column=1, padx=10)

    button_delete_item = Button(frame_buttons, text="Delete New menu item", bg="blue", fg="white")
